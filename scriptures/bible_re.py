...
('I Kings', '1Kgs', '(?:1|I)(?:\s)?K(?:(?:(?:in|gs)(?:gs|\.?)|.\?))', [53, 46, 28, 34, 18, 38, 51, 66, 28, 29, 43, 33, 34, 31, 34, 34, 24, 46, 21, 43, 29, 53]),
('II Kings', '2Kgs', '(?:2|II)(?:\s)?K(?:(?:(?:in|gs)(?:gs|\.?)|.\?))', [18, 25, 27, 44, 27, 33, 20, 29, 37, 36, 21, 21, 25, 29, 38, 20, 41, 37, 37, 21, 26, 20, 37, 20, 30]),
...
'nt': (
('Matthew', 'Matt', 'M(?:(?:t)\.?|(?:att\.?(?:hew)?))', [25, 23, 17, 25, 48, 34, 29, 34, 38, 42, 30, 50, 58, 36, 39, 28, 27, 35, 30, 34, 46, 46, 39, 51, 46, 75, 66, 20]),
('Mark', 'Mark', 'M(?:(?:k)\.?|(?:ark))', [45, 28, 35, 41, 43, 56, 37, 38, 50, 52, 33, 44, 37, 72, 47, 20]),
('Luke', 'Luke', 'L(?:(?:k)\.?|(?:uke))', [80, 52, 38, 44, 39, 49, 50, 56, 62, 42, 54, 59, 35, 35, 32, 31, 37, 43, 48, 47, 38, 71, 56, 53]),
('John', 'John', '(?<!(?:1|2|3|I)\s)(?<!(?:1|2|3|I))J(?:ohn|n\.)', [51, 25, 36, 54, 47, 71, 53, 59, 41, 42, 57, 50, 38, 31, 27, 33, 26, 40, 42, 31, 25]),
...
('I John', '1John', '(?:(?:1|I)(?:\s)?)J(?:ohn|n\.)', [10, 29, 24, 21, 21]),
