...
class TestBookNames(unittest.TestCase):
    ...
    def test_i_samuel(self):
        self.assertEqual(f('1 samuel 1:1'), '1 Samuel 1.1')
        self.assertEqual(f('1 samuel 1:1'), '1 Samuel 1.1')
        self.assertEqual(f('1 sam 1:1'), '1 Samuel 1.1')
        self.assertEqual(f('1 sam 1:1'), '1 Samuel 1.1')
    ...
    def test_i_kings(self):
        ...
        self.assertEqual(f('1 kings 1:1'), '1 Kings 1.1')
        self.assertEqual(f('1 kgs 1:1'), '1 Kings 1.1')
        self.assertEqual(f('1 kgs 1:1'), '1 Kings 1.1')
    ...
    def test_i_chronicles(self):
        ...
        self.assertEqual(f('1 chr 1:1'), '1 Chronicles 1.1')
        self.assertEqual(f('1 chro 1:1'), '1 Chronicles 1.1')
    ...
    def test_i_corinthians(self):
        self.assertEqual(f('1 corinthians 1:1'), '1 Corinthians 1.1')
        self.assertEqual(f('1 cor 1:1'), '1 Corinthians 1.1')
        self.assertEqual(f('1 corinthians 1:1'), '1 Corinthians 1.1')
        self.assertEqual(f('1 cor 1:1'), '1 Corinthians 1.1')

        self.assertEqual(f('1corinthians 1:1'), '1 Corinthians 1.1')
    ...
    def test_i_thessalonians(self):
        self.assertEqual(f('1 thessalonians 1:1'), '1 Thessalonians 1.1')
        self.assertEqual(f('1 thess 1:1'), '1 Thessalonians 1.1')
        self.assertEqual(f('1 thessalonians 1:1'), '1 Thessalonians 1.1')
        self.assertEqual(f('1 thess 1:1'), '1 Thessalonians 1.1')

        self.assertEqual(f('1thessalonians 1:1'), '1 Thessalonians 1.1')
    ...
    def test_i_timothy(self):
        ...
        self.assertEqual(f('1 tim 1:1'), '1 Timothy 1.1')
        self.assertEqual(f('1 timothy 1:1'), '1 Timothy 1.1')
        self.assertEqual(f('1 tim 1:1'), '1 Timothy 1.1')

        self.assertEqual(f('1timothy 1:1'), '1 Timothy 1.1')
    ...
    def test_i_peter(self):
        self.assertEqual(f('1 peter 1:1'), '1 Peter 1.1')
        self.assertEqual(f('1 pet 1:1'), '1 Peter 1.1')
        self.assertEqual(f('1 peter 1:1'), '1 Peter 1.1')
        self.assertEqual(f('1 pet 1:1'), '1 Peter 1.1')

        self.assertEqual(f('1peter 1:1'), '1 Peter 1.1')
